 ...
 * 											LOAD METHODS
 ============================================================================================================*/
	...
	public void loadPlace(List<PlaceType> placeList){
		mappingPlaces(placeList);
		for(PlaceType p: placeList) {
			placeSet.add(new MyPlaceType(p,mappingNamePlace));
		}
		loadRoadSegment(placeList);
		loadGate(placeList);
		loadParkingArea(placeList);
		loadConnection(placeList);
	return;
	}
	//this method load in the roadSegmentSet data structure all the roadSegments beloning the RNS
	public void loadRoadSegment(List<PlaceType> placeList){
		for(PlaceType p: placeList) {
	...
	public void loadGate(List<PlaceType> placeList){
		for(PlaceType p: placeList) {
	...
	public void loadParkingArea(List<PlaceType> placeList){
		for(PlaceType p: placeList) {
	...
	public void loadConnection(List<PlaceType> placeList){
		for(PlaceType p: placeList) {
	...
	public Map<String, PlaceType> getMappingNamePlace(){
		return mappingNamePlace;
	}
 ...
 * 										END LOAD METHODS
 ========================================================================================================*/
	...
	public void mappingPlaces(List<PlaceType> placeList){
		//create the hashmap
